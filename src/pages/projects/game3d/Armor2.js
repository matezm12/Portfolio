...
import armor2 from 'assets/cyborg.glb';
...
export const Armor2 = ({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      const loadGltf = modelLoader.loadAsync(armor2);
      ...
      gltf.scene.rotation.y = degToRad(0);
  ...
  return (
    <div
      className={classes(styles.armor2, className)}
      ref={container}
      role="img"
      aria-label={alt}
      {...rest}
